	...
	class ZURCF7_Admin_Action {
		...
		*/
		...
		function action__add_meta_boxes() {
			add_meta_box( 'zurcf7-data', __( 'Registration Form Data', 'user-registration-using-contact-form-7' ), array( $this, 'zurcf7_show_from_data' ), ZURCF7_POST_TYPE, 'normal', 'high' );
		}
		...
		function zurcf7_show_from_data( $post ) {
			...
			echo '<tr class="form-field">' .
				'<th scope="row">' .
					'<label for="hcf_author">' . esc_html__( 'CF7 Form Name', 'user-registration-using-contact-form-7' ) . '</label>' .
				'</th>' .
			...
			echo '<tr class="form-field">' .
				'<th scope="row">' .
					'<label for="hcf_author">' . esc_html__( 'User Email', 'user-registration-using-contact-form-7' ) . '</label>' .
				'</th>' .
			...
			echo '<tr class="form-field">' .
				'<th scope="row">' .
					'<label for="hcf_author">' . esc_html__( 'User Name', 'user-registration-using-contact-form-7' ) . '</label>' .
				'</th>' .
				'<td>'.esc_html($user_login).'</td>' .
			'</tr>';
			echo '<tr class="form-field">' .
				'<th scope="row">' .
					'<label for="hcf_author">' . esc_html__( 'User Role', 'user-registration-using-contact-form-7' ) . '</label>' .
				'</th>' .
			...
			if( !empty( $social_type ) ) {
				echo '<tr class="form-field">' .
					'<th scope="row">' .
						'<label for="hcf_author">' . esc_html__( 'Type', 'user-registration-using-contact-form-7' ) . '</label>' .
					'</th>' .
